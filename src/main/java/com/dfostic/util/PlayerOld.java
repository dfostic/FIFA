...
@Entity
@Table(name = "player")
public class PlayerOld implements IPlayer, Serializable {
    ...
    public PlayerOld(String firstName, String lastName, LocalDate dateOfBirth, Locale country, Position position, BigDecimal salary, Statistics statistics, Currency currency) {
    ...
    public boolean equals(Object obj) {
        ...
        final PlayerOld other = (PlayerOld) obj;
